...
**Routing**: Client-side routing via Wouter (lightweight React router), with protected routes based on authentication state and user roles (student vs teacher).
...
- Login: Simple email/display name authentication with role selection
...
- Teacher Dashboard: Student analytics and progress monitoring
...
**Users Table**: Stores student/teacher accounts with progression metrics
...
- Role differentiation: student vs teacher
